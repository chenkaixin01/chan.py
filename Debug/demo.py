...
if __name__ == "__main__":
    ...
    meta = json.load(open("T1_buy_selected_feature.meta", "r"))
    model = xgb.XGBClassifier()
    model.load_model("T1_buy_selected_model.json")
    # predict
    ...
    X_train, y_train = load_svmlight_file("T1_buy_selected_smote_tomek_train.libsvm")
    X_val, y_val = load_svmlight_file("T1_buy_selected_val.libsvm")
    X_test, y_test = load_svmlight_file("T1_buy_selected_test.libsvm")
    ...
    # t1_sell_loaded_model = xgb.XGBClassifier()
